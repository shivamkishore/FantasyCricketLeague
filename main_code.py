...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background-color: rgb(92, 219, 209);")
        ...
        self.BAT.setStyleSheet("color: rgb(0,0,0);")
        ...
        self.WK.setStyleSheet("color: rgb(0,0,0);")
        ...
        self.team_name.setStyleSheet("color: rgb(0,0,0);")
